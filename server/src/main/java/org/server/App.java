...
/*        configuration.addAnnotatedClass(Report.class);
    ...
    private static List<PreMadeProduct> generateProducts() throws Exception {       //generates new products
        ...
        List<PreMadeProduct> products = new LinkedList<PreMadeProduct>();
        String[] flowerNames = new String[]{"Rakefet","Calanit","Shibolet","Rose","SunFlower","Lilach","Lily","Tulip","Pickachu","Charmander","Thanos","PushPush","Runlater","Clean Install","Orchid"};
        for(int i=0;i< flowerNames.length;i++){
            var img = loadImageFromResources(String.format("Flower%s.jpg",i%5));
